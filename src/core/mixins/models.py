...
class MetaMixin(models.Model):
    """
    Adds meta_title and meta_description fields to a model
    """
...
class URLMixin(models.Model):
    ...
    internal_link = PageField(
        related_name="%(app_label)s_%(class)s_internal_links", blank=True, null=True
    )
...
class FileMixin(models.Model):
    """
    Helper mixin to add a file field to a model
    """
